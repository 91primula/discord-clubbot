...
async def on_inter(i: discord.Interaction):
    ...
    if cid == "haribocmd":
        ...
        guide = (
                "🧸하리보 명령어 모음🧸\n"
                "!!재생 <노래 제목 or URL>                : 유튜브 검색 후 첫 영상 재생\n"
                "!!검색 <노래 제목>                              : 유튜브 검색 후 목록 보여줌, 목록 중 선택하여 재생\n"
                "!!다음에재생 <노래 제목>                : 다음 대기열에 추가\n"
                "!!현재                                                      : 현재 재생중인 내용 확인\n"
                "!!대기열                                                 : 대기중인 재생 목록 확인\n"
                "!!멜론차트 <1~100 사이 숫자>        : 멜론차트 1등부터 선택한 숫자 사이의 곡 재생\n"
                "!!지니차트 <1~100 사이 숫자>        : 지니차트 1등부터 선택한 숫자 사이의 곡 재생\n"
